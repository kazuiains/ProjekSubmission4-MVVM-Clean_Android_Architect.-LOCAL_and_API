package com.muhammad_adi_yusuf.projeksubmission4.view.listener;
...
public class IcsRecyclerView {
    ...
    private IcsRecyclerView(RecyclerView recyclerView) {
        ...
        RecyclerView.OnChildAttachStateChangeListener attchListener = new RecyclerView.OnChildAttachStateChangeListener() {
            @Override
