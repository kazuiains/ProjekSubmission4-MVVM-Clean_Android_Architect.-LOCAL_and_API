...
public class TvFragment extends Fragment {
    ...
    private ArrayList<ApisItem> tvsItem = new ArrayList<>();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adaPter = new AdapterRview(getContext(), tvsItem);
        ...
        IcsRecyclerView.addTo(recyclerView).setOnItemClickListener(new IcsRecyclerView.OnItemClickListener() {
            ...
            public void onItemClicked(RecyclerView recyclerView, int poSition, View v) {
                ...
                ApisItem iTem = tvsItem.get(poSition);
    ...
    private Observer<List<ApisItem>> getData = new Observer<List<ApisItem>>() {
        @Override
        public void onChanged(List<ApisItem> tvsItem) {
            if (tvsItem != null) {
