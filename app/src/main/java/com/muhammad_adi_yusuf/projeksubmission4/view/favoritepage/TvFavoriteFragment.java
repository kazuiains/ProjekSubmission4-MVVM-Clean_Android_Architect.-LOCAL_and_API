...
public class TvFavoriteFragment extends Fragment {
    ...
    private ArrayList<FavoriteTable> tvItem = new ArrayList<>();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getAllTv().observe((LifecycleOwner) Objects.requireNonNull(getContext()), getData);

        adaPter = new AdapterFavRview(getContext(), tvItem);
        ...
        IcsRecyclerView.addTo(recyclerView).setOnItemClickListener(new IcsRecyclerView.OnItemClickListener() {
            ...
            public void onItemClicked(RecyclerView recyclerView, int poSition, View v) {
                ...
                FavoriteTable iTem = tvItem.get(poSition);
    ...
    private Observer<List<FavoriteTable>> getData = new Observer<List<FavoriteTable>>() {
        @Override
        public void onChanged(List<FavoriteTable> tvItem) {
            if (tvItem != null) {
                progressBar.setVisibility(View.GONE);
                adaPter.setData(tvItem);
            } else {
